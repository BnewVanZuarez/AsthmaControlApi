...
INSERT INTO `rencana_aksi_asma` (`id`, `users_id`, `nama_dokter`, `telp_dokter`, `kontak_darurat`, `telp_darurat`, `nama_obat`, `dosis_obat`, `digunakan_saat`, `instruksi_tambahan`, `pemicu`, `hijau_peakflow_dari`, `hijau_peakflow_ke`, `kuning_peakflow_dari`, `kuning_peakflow_ke`, `merah_peakflow_dari`, `merah_peakflow_ke`, `tanggal_input`) VALUES
	(1, 6, 'Dr. John Doe', '08111111111', 'Jane Doe', '08111111112', 'Paracetamol', '10Mg', 'Sesudah Makan', 'Tidak ada', 'Serbuk Sari, Aktivitas Berat, Jamur, Influenza, Tungau Debu, Perubahan Cuaca, Hewan Tertentu, Polisi Udara, Asap, Makanan, Lain-lain.', NULL, NULL, NULL, NULL, NULL, NULL, '2022-08-08 22:10:14'),
	(2, 6, 'Dr. Jane Doe', '08111111111', 'John Doe', '0811111112', 'Paracetamol', '10mg', 'Sebelum Olah Raga', 'Tidak ada', 'Serbuk Sari, Aktivitas Berat, Jamur, Asap, ', '1', '2', '2', '3', '3', '4', '2022-08-08 22:57:35'),
	(3, 6, 'Dr. Fatih Abinawa', '08111111111', 'Abinawa Fatih', '08111111112', 'Obat A', '10Mg', 'Sebelum Olahraga', 'Tidak ada', 'Aktivitas Berat, Polisi Udara, Asap, ', '1', '2', '2', '3', '3', '4', '2022-08-08 23:07:59'),
	(4, 6, 'John Doe', '08111111111', 'Jane Doe', '08111111112', 'Obat A', '10Mg', 'Pemanasan', 'Tidak Ada', 'Polisi Udara, Asap, Makanan, ', '1', '2', '2', '3', '3', '4', '2022-08-09 00:15:20'),
	(5, 6, 'QW', '122', 'bfcg', '1212', 'fgd', '31g', '23', '23', 'Serbuk Sari, Aktivitas Berat, Jamur, Influenza, ', '99', '34', '12', '654', '543', '564', '2022-08-09 01:14:14'),
	(6, 6, 'John Doa', '0812543789', 'Jane Doe', '84305769', 'Obat', '100', 'Sebelum', 'Tidak ada', 'Serbuk Sari, Aktivitas Berat, Jamur, Influenza, Tungau Debu, Perubahan Cuaca, Hewan Tertentu, Polisi Udara, Asap, Makanan, Lain-lain.', NULL, NULL, NULL, NULL, NULL, NULL, '2022-08-09 01:22:32'),
	(7, 6, 'Dr. John Doe', '08123456789', 'Jane Doe', '08123456788', 'Obat A', '15mg', 'Sebelum', '-', 'Serbuk Sari, Aktivitas Berat, Jamur, Influenza, Tungau Debu, Perubahan Cuaca, Hewan Tertentu, Polisi Udara, Asap, Makanan, Lain-lain.', '1', '2', '2', '3', '3', '4', '2022-08-09 01:28:59'),
	(8, 6, 'Dr. Fatih D Abinawa', '089123456789', 'Jane Doe', '089123456788', 'Paracetamol', '10Mg', 'Sebelum Olahraga', '-', 'Serbuk Sari, Aktivitas Berat, Tungau Debu, Polisi Udara, Asap, ', '1', '2', '2', '3', '3', '4', '2022-08-09 01:48:45');
...
INSERT INTO `rencana_aksi_asma_obat` (`id`, `rencana_id`, `zona`, `jenis_obat`, `dosis`, `waktu_konsumsi`) VALUES
	(1, 2, 3, '10Mg', 'Pagi', '1'),
	(2, 4, 3, 'Obat', '10', 'Pagi'),
	(3, 4, 3, 'Obat', '15', 'Pagi'),
	(4, 5, 3, ';m,l;', '132', 'teyuwq'),
	(5, 5, 3, 'fdsf', '132g', 'fd'),
	(6, 7, 3, 'Hijau 1', '10', 'A'),
	(7, 7, 3, 'Hijau 2', '15', 'B'),
	(8, 7, 2, 'Kuning 1', '10', 'A'),
	(9, 7, 2, 'Kuning 2', '15', 'B'),
	(10, 7, 1, 'Merah 1', '10', '1'),
	(11, 8, 3, 'Hijau 1', '10mg', '1x1'),
	(12, 8, 2, 'Kuning 1', '10mg', '2x1'),
	(13, 8, 1, 'Merah 1', '15mg', '3x1');
